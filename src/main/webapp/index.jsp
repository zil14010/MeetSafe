...
<div class="login layui-anim layui-anim-up" style="width: 800px;">
    ...
    <div class="layui-form">
        <div class="layui-form-item">
            <input id="loginName" name="id" placeholder="User name" type="text" lay-verify="required" class="layui-input">
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            <div class="layui-input-inline" style="width: 350px;">
                <input type="radio" name="userType" title="Admin"  checked="" value="1">

                <input type="radio" name="userType" title="Student"  value="2">
            </div>
        </div>
        <div class="layui-form-item">
...
<script>
    $(function () {
        ...
        $("#captcha").click(function () {
            this.src = "/system/getCaptcha?t=" + new Date().getTime();
        });
