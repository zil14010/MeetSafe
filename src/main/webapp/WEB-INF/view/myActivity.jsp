...
<header class="tm-header" id="tm-header">
    <div class="tm-header-wrapper">
        ...
        <nav class="tm-nav" id="tm-nav">
            <ul>
                <li class="tm-nav-item"><a href="${pageContext.request.contextPath}/system/activitySquare" class="tm-nav-link">
...
</div><script src="${pageContext.request.contextPath}/static/js/jquery.min.js"></script>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $.ajax({
            type: "POST",
            url: "${pageContext.request.contextPath}/activity/getActivityBystudentID",//查询数据
            dataType:"json",
            data: student.id,//当前登陆者的用户ID
            success: function(ajaxResponse){//该对象为查询后返回的数据
                var data = ajaxResponse.data//一个集合
                //获取隐藏模板
                var div
